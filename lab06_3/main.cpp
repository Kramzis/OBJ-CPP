...
void fun(vector<T> wek){
    ...
    cout<<"Ilosc liczb mniejszych niz sredania: "<<p1<<endl;
    cout<<"Ilosc liczb znajdujacych sie pomiedzy srednia a mediana: "<<p2<<endl;
    cout<<"Ilosc liczb dodatnich: "<<p3<<endl;
